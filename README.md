...
To build the final jar and optimize the uaaservice application for production, run:
...
[Using UAA for Microservice Security]: https://www.jhipster.tech/documentation-archive/v6.7.0/using-uaa/[Using JHipster in development]: https://www.jhipster.tech/documentation-archive/v6.7.0/development/
